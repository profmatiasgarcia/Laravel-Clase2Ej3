...
<head>
    ...
    <title>Clase Laravel 2 - Ejemplo 3</title>
...
<body>
    <div class="flex-center position-ref full-height">
        ...
        <div class="content">
            ...
            <div class="links">
                <a href="{{ route('ejformulario') }}">Formulario</a>
                <a href="{{ route('createuser') }}">Crear nuevo usuario</a>
                <a href="{{ route('formulario2') }}">Formulario Encuestas</a>
            </div>
        </div>
    </div>
</body>
